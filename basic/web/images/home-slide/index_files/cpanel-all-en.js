...
(function() {
    // The raw lexicon.
    var newLex = {"Passwords must be at least [quant,_1,character,characters] long.":"Passwords must be at least [quant,_1,character,characters] long.","An unknown error occurred.":"An unknown error occurred.","Success!":"Success!","The API response could not be parsed.":"The API response could not be parsed.","Password strength must be at least [numf,_1].":"Password strength must be at least [numf,_1].","Click to close.":"Click to close."};
